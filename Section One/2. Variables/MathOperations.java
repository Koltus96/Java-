public class MathOperations {
    public static void main(String[] args) {
        ...
        System.out.println("Fred and George used a special spell to multiple their sweets to: " + (bagOfSweets1 * bagOfSweets2));
        ...
        System.out.println("Andromeda has " + (starsInAndromeda / starsInMilkyWay) + " more times stars than the Milky Way");
